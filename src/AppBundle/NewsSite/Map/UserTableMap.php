...
class UserTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src\AppBundle.NewsSite.Map.UserTableMap';
     ...
     */
    const OM_CLASS = '\\AppBundle\\NewsSite\\User';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src\AppBundle.NewsSite.User';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\AppBundle\\NewsSite\\User');
    ...
    {
        $this->addRelation('Item', '\\AppBundle\\NewsSite\\Item', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':user_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \AppBundle\NewsSite\User) { // it's a model object
