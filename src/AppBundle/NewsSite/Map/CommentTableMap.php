...
class CommentTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src\AppBundle.NewsSite.Map.CommentTableMap';
     ...
     */
    const OM_CLASS = '\\AppBundle\\NewsSite\\Comment';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src\AppBundle.NewsSite.Comment';
     ...
     */
    const COL_ITEM_ID = 'comment.item_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Content', 'Date', 'UserId', 'ItemId', ),
        self::TYPE_CAMELNAME     => array('id', 'content', 'date', 'userId', 'itemId', ),
        self::TYPE_COLNAME       => array(CommentTableMap::COL_ID, CommentTableMap::COL_CONTENT, CommentTableMap::COL_DATE, CommentTableMap::COL_USER_ID, CommentTableMap::COL_ITEM_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'content', 'date', 'user_id', 'item_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Content' => 1, 'Date' => 2, 'UserId' => 3, 'ItemId' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'content' => 1, 'date' => 2, 'userId' => 3, 'itemId' => 4, ),
        self::TYPE_COLNAME       => array(CommentTableMap::COL_ID => 0, CommentTableMap::COL_CONTENT => 1, CommentTableMap::COL_DATE => 2, CommentTableMap::COL_USER_ID => 3, CommentTableMap::COL_ITEM_ID => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'content' => 1, 'date' => 2, 'user_id' => 3, 'item_id' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\AppBundle\\NewsSite\\Comment');
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Item', '\\AppBundle\\NewsSite\\Item', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':item_id',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CommentTableMap::COL_ITEM_ID);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \AppBundle\NewsSite\Comment) { // it's a model object
