...
namespace AppBundle\NewsSite\Map;
...
class ItemTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src\AppBundle.NewsSite.Map.ItemTableMap';
     ...
     */
    const OM_CLASS = '\\AppBundle\\NewsSite\\Item';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src\AppBundle.NewsSite.Item';
     ...
     */
    const COL_DATE = 'item.date';

    /**
     * the column name for the user_id field
     */
    const COL_USER_ID = 'item.user_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'Description', 'Date', 'UserId', ),
        self::TYPE_CAMELNAME     => array('id', 'title', 'description', 'date', 'userId', ),
        self::TYPE_COLNAME       => array(ItemTableMap::COL_ID, ItemTableMap::COL_TITLE, ItemTableMap::COL_DESCRIPTION, ItemTableMap::COL_DATE, ItemTableMap::COL_USER_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'title', 'description', 'date', 'user_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'Description' => 2, 'Date' => 3, 'UserId' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'title' => 1, 'description' => 2, 'date' => 3, 'userId' => 4, ),
        self::TYPE_COLNAME       => array(ItemTableMap::COL_ID => 0, ItemTableMap::COL_TITLE => 1, ItemTableMap::COL_DESCRIPTION => 2, ItemTableMap::COL_DATE => 3, ItemTableMap::COL_USER_ID => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'title' => 1, 'description' => 2, 'date' => 3, 'user_id' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\AppBundle\\NewsSite\\Item');
        $this->setPackage('src\AppBundle.NewsSite');
        ...
        $this->getColumn('description')->setPrimaryString(true);
    ...
    {
        $this->addRelation('User', '\\AppBundle\\NewsSite\\User', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':user_id',
    1 => ':id',
        ...
        $this->addRelation('Comment', '\\AppBundle\\NewsSite\\Comment', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':item_id',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ItemTableMap::COL_DATE);
            $criteria->addSelectColumn(ItemTableMap::COL_USER_ID);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \AppBundle\NewsSite\Item) { // it's a model object
