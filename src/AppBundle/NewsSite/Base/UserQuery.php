...
use AppBundle\NewsSite\Map\UserTableMap;
 ...
 *
 * @method     \AppBundle\NewsSite\ItemQuery|\AppBundle\NewsSite\CommentQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class UserQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \AppBundle\NewsSite\Base\UserQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\AppBundle\\NewsSite\\User', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \AppBundle\NewsSite\Item object
     *
     * @param \AppBundle\NewsSite\Item|ObjectCollection $item the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    {
        if ($item instanceof \AppBundle\NewsSite\Item) {
            return $this
                ->addUsingAlias(UserTableMap::COL_ID, $item->getUserId(), $comparison);
            ...
            throw new PropelException('filterByItem() only accepts arguments of type \AppBundle\NewsSite\Item or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \AppBundle\NewsSite\ItemQuery A secondary query class using the current class as primary query
     */
    public function useItemQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinItem($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Item', '\AppBundle\NewsSite\ItemQuery');
    }
