...
abstract class User implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\AppBundle\\NewsSite\\Map\\UserTableMap';
    ...
    /**
     * Initializes internal state of AppBundle\NewsSite\Base\User object.
     */
     ...
     * @return $this|\AppBundle\NewsSite\User The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\AppBundle\\NewsSite\\User'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->itemsScheduledForDeletion !== null) {
                if (!$this->itemsScheduledForDeletion->isEmpty()) {
                    \AppBundle\NewsSite\ItemQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\AppBundle\NewsSite\User
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\AppBundle\NewsSite\User The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \AppBundle\NewsSite\User (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \AppBundle\NewsSite\User Clone of current object.
     * @throws PropelException
     */
    ...
    public function initItems($overrideExisting = true)
    {
        ...
        $this->collItems->setModel('\AppBundle\NewsSite\Item');
    }
     ...
     * @return ObjectCollection|ChildComment[] List of ChildComment objects
     */
    public function getCommentsJoinItem(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildCommentQuery::create(null, $criteria);
